...
<script>
    ...
    function loadProject(arrData) {
        ...
        arrData.forEach((item, i) => {
            ...
            htmlgrid += '<img src="../../vendor/img/product-3/2.jpg" alt="#" /></a>';
            ...
            htmlgrid += '<h6>' + item.pro_type_name + '</h6><small>ตัวแทนขาย</small></div></div>';
            htmlgrid += '<div class="product-hover-action">';
            htmlgrid += '<ul><li style="width: 100px;"><a href="tel:' + item.pro_type_name + '" title="ติดต่อตัวแทนขาย"><i class="fas fa-phone">&nbsp;โทร</i></a></li></ul>';
            htmlgrid += '</div></div></div></div>';

            htmllist += '<div class="col-lg-12"><div class="ltn__product-item ltn__product-item-4 ltn__product-item-5">';
            htmllist += '<div class="product-img"><a href="project-details.aspx?id='+ item.plan_type_id +'"><img src="../../vendor/img/product-3/2.jpg" alt="#" /></a></div>';
            ...
            htmllist += '<h6>' + item.pro_type_name + '</h6><small>ตัวแทนขาย</small></div></div>';
            htmllist += '<div class="product-hover-action"><ul><li style="width: 100px;"><a href="tel:' + item.pro_type_name + '" title="ติดต่อตัวแทนขาย">';
